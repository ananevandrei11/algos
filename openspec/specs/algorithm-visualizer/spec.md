# algorithm-visualizer Specification

## Purpose

Provide a reusable, data-driven step player for visualizing algorithms, with per-algorithm view components and answers verified against the real functions from `src/`.
