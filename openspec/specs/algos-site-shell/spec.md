# algos-site-shell Specification

## Purpose

Provide an isolated Vite + React + TypeScript application in `site/` that reuses the root project's algorithms read-only and exposes a catalog with type-safe routes.
