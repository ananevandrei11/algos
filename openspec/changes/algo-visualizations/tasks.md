...
- [x] 10.2 Run `cd site && npm run dev`, walk every page: Step/Auto/Reset work, log reads sensibly, source block shows the `src/` file, verification line is green
- [x] 10.3 Run `cd site && npm run build` (`tsc --noEmit && vite build`) — types and build clean
